...
function Twitbox() {
  ...
  return (
    <div className='flex space-x-2 p-5'>
        <img src='https://links.papareact.com/gll' className='h-14 w-14 mt-4 object-cover rounded-full'/>
    ...
    <div className='flex flex-1 items-center pl-2'>
        <form className='flex flex-1 flex-col'>
            ...
            <div className='flex items-center'>
                <div className='flex flex-1 space-x-2 text-blue-600'>
                ...
                <button disabled={!input} className='px-5 py-2 rounded-full bg-blue-500 text-white font-bold disabled:opacity-40'>Tweet</button>
            </div>
